package com.varadhisoft.java.designpatterns.builder;
...
public class StreetMap {
	...
	public static void main(String args[]) {
		StreetMap map = new StreetMap.Builder(new Point(50, 50), new Point(1000,
				1000)).landColor(Color.RED).waterColor(Color.BLUE.brighter())
				.build();
