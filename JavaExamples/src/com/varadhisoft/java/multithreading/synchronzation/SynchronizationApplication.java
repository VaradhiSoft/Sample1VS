...
class Account {
	...
	void withdraw(float amount) {
		...
		System.out.println("Balance of A/C no " + accno + " is Rs."
				+ getBalance());
		System.out.println("Trying to withdraw Rs." + amount + " from A/C "
				+ accno);
		...
		synchronized (this) {
			...
			if (bal >= amount) {
				...
				setBalance(bal);
				System.out.println(" Hello " + accno + ", Please collect Rs."
						+ amount);
			} else {
				System.out.println("Cannot process the request of " + accno
						+ ". Insufficient funds.");
			}
		}
		System.out.println("Withdrawl operation of A/C " + accno
				+ " is completed.");
	}
...
public class SynchronizationApplication {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.out.println(" After withdrwal balance in account is Rs."
				+ a1.getBalance()); // 2000

		// System.out.println(" After withdrwal balance in second account is
		// Rs."+a2.getBalance()); // 0
